...
using WebApiSample.ClientEntities.Models;

namespace WebApiSample.ConsoleClient
{
    class Program
    {
        static void Main()
        {
            ...
            IEnumerable<Customer> customers = GetCustomersWithOrders(client);
        ...
        private static IEnumerable<Customer> GetCustomersWithOrders(HttpClient client)
        {
